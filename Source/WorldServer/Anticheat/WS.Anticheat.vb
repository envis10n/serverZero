...
Public Module WS_Anticheat
    ...
    Public Sub MovementEvent(ByRef client As ClientClass, ByVal RunSpeed As Single, ByVal posX As Single, ByVal positionX As Single, ByVal posY As Single, ByVal positionY As Single, ByVal posZ As Single, ByVal positionZ As Single, ByVal sTime As Int32, ByVal cTime As Int32)
        Dim sData As SpeedHackViolation
        Dim pChar As CharacterObject = client.Character
        ...
        If sData.LastViolation <> ViolationType.AC_VIOLATION_NONE Then
            ...
            Log.WriteLine(LogType.INFORMATION, "[AntiCheat] Player {0} triggered a speedhack violation. ({1}) {2}", client.Character.Name, sData.Violations, sData.LastMessage)
            If sData.Violations >= 10 Then
                Log.WriteLine(LogType.USER, "[AntiCheat] Player {0} exceeded violation value. Taking action.", client.Character.Name)
                'Take Action
